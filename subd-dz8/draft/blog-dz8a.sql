...
VALUES (1, 'user1', 123123, false),  (2, 'user2', 123123, false),  (3, 'user3', 123123, false);

INSERT INTO post(id, post, dt, title, author_user_id, last_edit_dt, lead, visible, referenced_post_id, deleted) 
VALUES 
