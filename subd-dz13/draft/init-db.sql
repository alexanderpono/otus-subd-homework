...
CREATE TABLE IF NOT EXISTS `blog_db`.`post` (
  ...
  `views_count` INT NOT NULL DEFAULT 0 COMMENT 'количество просмотров статьи\nNOT NULL, DEFAULT=0\nкардинальность - растет',
  `likes_count` SMALLINT NOT NULL DEFAULT 0 COMMENT 'количество лайков статьи\nNOT NULL, DEFAULT=0\nкардинальность - растет',
  PRIMARY KEY (`id`),
